...
/* Codigo fuente del sistema de sensado de la zona 2
Elaborado por:
...
void loop() {
  ...
  if ( (millis() - lastPublishMillis) > updateInterval*1000) {
    ...
    float ht = analogRead(35);  // Lee la humedad del suelo
    ...
    // Publicar los valores en el canal de ThingSpeak (field5, field6, field7)
    mqttPublish( channelID, (String("field5=")+String(t) + String("&field6=")+String(h) + String("&field7=")+String(ht) ) );
